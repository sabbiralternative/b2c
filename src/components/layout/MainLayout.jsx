            ...
            >
              <div className="container-xxl d-flex h-100 flex-column p-0">
                ...
                <div className="navbar-brand app-brand demo d-xl-flex py-0 me-4">
                  <a href="index.php" className="app-brand-link gap-2">
                ...
                <ul
                  className="menu-inner overflow-auto"
                ...
                >
                  ...
                  <li className="menu-item">
                    ...
                    <ul className="menu-sub">
                      <li className="menu-item">
                        <a href="view_branches.php" className="menu-link">
                          <i className="menu-icon tf-icons bx bxs-institution"></i>
                          <div data-i18n="View Branches">View Branches</div>
                        </a>
                      </li>
                      ...
                      <li className="menu-item">
                        <a href="add_branch.php" className="menu-link">
                          <i className="menu-icon tf-icons bx bxs-institution"></i>
                          <div data-i18n="Add Branch">Add Branch</div>
                        </a>
                      </li>
                  ...
                  <li className="menu-item">
                    ...
                    <ul className="menu-sub">
                      <li className="menu-item">
                        <a href="view_banners.php" className="menu-link">
                          <i className="menu-icon tf-icons bx bxs-institution"></i>
                          <div data-i18n="View Banners">View Banners</div>
                        </a>
                      </li>
                      ...
                      <li className="menu-item">
                        <a href="add_banner.php" className="menu-link">
                          <i className="menu-icon tf-icons bx bxs-institution"></i>
                          <div data-i18n="Add Banner">Add Banner</div>
                        </a>
                      </li>
                      ...
                      <li className="menu-item">
                        <a href="social_links.php" className="menu-link">
                          <i className="menu-icon tf-icons bx bxs-institution"></i>
                          <div data-i18n="Social Links">Social Links</div>
                        </a>
                      </li>
